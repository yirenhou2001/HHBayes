---
title: "HHBayes Tutorial: A Complete Workflow"
author: "HHBayes Development Team"
date: "`r Sys.Date()`"
output: 
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{HHBayes Tutorial: A Complete Workflow}
...
This vignette provides a step-by-step tutorial for using the **HHBayes** package to simulate household transmission data, prepare it for Bayesian inference, run Stan models, assess convergence, and produce publication-quality figures.

**HHBayes** provides a unified framework for:
...
HHBayes implements a discrete-time stochastic transmission model. For individual $i$ in household $h$ at time $t$, the force of infection is:
...
HHBayes accepts two data formats:
